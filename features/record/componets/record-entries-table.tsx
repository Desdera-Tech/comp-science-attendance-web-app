...
import { useRecordEntries } from "../hooks/use-record";
import { useRecordEntriesTableState } from "../hooks/use-table-state";
import { RecordEntry } from "../types";

const columns: ColumnDef<RecordEntry>[] = [
        ...
        <>
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end">
              ...
              <Link href={`/admin/records/${recordId}/entries/${id}`}>
...
export function RecordEntriesTable({ recordId }: { recordId: string }) {
  const tableState = useRecordEntriesTableState();

  const { data, isPending, isFetching, status, refetch } = useRecordEntries(
    recordId,
    {
            ...
            {isPending ? (
              ...
              <TableRow>
                ...
                >
                  ...
                  {status === "success" && <div>No entries found.</div>}
                </TableCell>
              </TableRow>
            )}
          </TableBody>
