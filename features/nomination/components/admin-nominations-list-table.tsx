        ...
        <>
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end">
              ...
              <Link href={`/admin/nominations/${id}`}>
                <DropdownMenuItem className="cursor-pointer">
                  <EyeIcon /> View nomination list
                </DropdownMenuItem>
              </Link>
            </DropdownMenuContent>
          </DropdownMenu>
...
export function NominationsListTable() {
  const tableState = useNominationsTableState();

  const { data, isPending, isFetching, status, refetch } = useNominationsList({
                ...
                >
                  {status === "error" && (
                    <div className="text-destructive">
                      An error occurred while fetching nominations list.
                    </div>
                  )}
                  {status === "success" && (
                    <div>No nominations list found.</div>
                  )}
                </TableCell>
              </TableRow>
            )}
